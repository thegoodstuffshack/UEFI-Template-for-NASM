...
; see https://uefi.org/sites/default/files/resources/UEFI_Spec_2_10_A_Aug8.pdf
	...
	ProgramFileName  dw __utf16__ `\\EXAMPLE\\PATH.bin\0`
	ProgramSignature db 'SIGNATUR' ; up to 8 bytes checked (can have more)

	; Optional Data Space
	DataFileProtocol dq 0
	DataFilePtr   dq 0
	DataFileSize  dq 0
	DataFileName  dw __utf16__ `\\EXAMPLE\\PATH.bin\0`
